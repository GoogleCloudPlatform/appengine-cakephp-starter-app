    ...
    <div id="content">
        ...
        <div class="row">
            ...
            <div class="columns large-6 filesystem checks">
                ...
                <?php $settings = Log::config('debug'); ?>
                <?php if (!empty($settings)): ?>
                    <?php if (strpos($settings['className'], 'FileLog') === false): ?>
                        <p class="success">The <em><?= $settings['className'] ?></em> is being used for logging. To change the config edit config/app.php</p>
                    <?php else: ?>
                        <p class="problem">The <em>FileLog</em> logger is not supported. Please check the settings in config/app.php</p>
                    <?php endif; ?>
                <?php else: ?>
                    <p class="problem">Logging is not configured. Please check the settings in config/app.php</p>
                <?php endif; ?>
