...
// Use the environment variable CAKEPHP_DEBUG to control debug output.
$debug = (bool)getenv('CAKEPHP_DEBUG');

// Select the database
if (isDevelServer()) {
  $db_host = getenv('DEV_DB_HOSTNAME');
  $db_port = getenv('DEV_DB_PORT');
  $db_unix_socket = getenv('DEV_DB_UNIXSOCKET');
  $db_user = getenv('DEV_DB_USERNAME');
  $db_password = getenv('DEV_DB_PASSWORD');
  $db_database = getenv('DEV_DB_DATABASE');
} else {
  $db_host = getenv('PROD_DB_HOSTNAME');
  $db_port = getenv('PROD_DB_PORT');
  $db_unix_socket = getenv('PROD_DB_UNIXSOCKET');
  $db_user = getenv('PROD_DB_USERNAME');
  $db_password = getenv('PROD_DB_PASSWORD');
  $db_database = getenv('PROD_DB_DATABASE');
}
